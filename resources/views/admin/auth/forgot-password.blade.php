            ...
            <form class="card card-md" action="{{ route('admin.password.email') }}" method="POST" autocomplete="off"
                ...
                <div class="card-body">
                    ...
                    <div class="form-footer">
                        <x-primary-button
                            class="btn btn-primary btn-4 w-100">{{ __('Email Password Reset Link') }}</x-primary-button>
                    </div>
                </div>
            </form>
            <div class="text-center text-secondary mt-3">Forget it, <a href="{{ route('admin.login') }}">send me
                    back</a> to the sign in screen.</div>
        </div>
    </div>
